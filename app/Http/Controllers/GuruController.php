...
class GuruController extends AppBaseController
{
    ...
    {
        $gurus = $this->guruRepository->paginate(12);
    ...
    public function search3(Request $request)
    {
        ...
        $gurus = \App\Models\Guru::where('kode_guru','like','%'.$search3.'%')
                ->orWhere('name','like','%'.$search3.'%')
                ->orWhere('almt_guru','like','%'.$search3.'%')
                ->orWhere('tlp_guru','like','%'.$search3.'%')
                ->paginate();
        return view('gurus.index')
        ->with('gurus', $gurus);
    }
    ...
    public function store(CreateGuruRequest $request)
    {
        ...
        Flash::success('Guru sukses tersimpan.');
    ...
    public function update($id, UpdateGuruRequest $request)
    {
        ...
        Flash::success('Guru sukses terupdate.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Guru sukses terhapus.');
